...
${user.username}
	<div class="inner">
		...
		<div class="infos">
		<div id="localImag"><center><img src="res/headpic/${user.headpic}" width="80" height="80" name="pic"/></center></div>  
			<br><br>
			<center>
			 <form action="update" method="post" enctype="multipart/form-data" target="header">
